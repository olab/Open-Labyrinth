<form action="../editSave/<?php echo $userId; ?>" method="post">
    <table>

        <tr><td align="left"><p>Editing user</p></td></tr>

        <tr><td align="left"><p>password</p></td><td align="left"><input type="password" name="upw" size="20" value="" /></td></tr>
        <tr><td align="left"><p>username</p></td><td align="left"><input type="text" name="uname" size="50" value="" /></td></tr>
        <tr><td align="left"><p>display name</p></td><td align="left"><input type="text" name="udname" size="50" value="" /></td></tr>
        <tr><td align="left"><p>e-mail</p></td><td align="left"><input type="text" name="uemail" size="50" value="" /></td></tr>

        <tr><td align="left"><p>user type</p></td>
            <td align="left">
