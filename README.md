...
OpenLabryinth can be installed on a basic web server running Apaache, MySQL, and PHP (eg a LAMP, WAMP setup etc.) 

If you are comfortable using Git to clone, pull etc, this will work fine. For less experienced users, an alternative is to 
download version 3.0.2 as a zip file (see the Releases tab). Expand that zip file into a set of folders accessible to your 
Apache server. 
...
Version 3.0.2 is very stable and recommended for production settings. 
