                ...
                <td>
                    ...
                    <div class="modal hide alert alert-block alert-error fade in" id="delete-tip-<?php echo $tip->id; ?>">
                        ...
                        <div class="modal-body">
                            <p><?php printf(__('You have just clicked the delete button, are you certain that you wish to proceed with deleting "%s" tip?'),$tip->title); ?></p>
                            <p>
                                <a class="btn btn-danger" href="<?php echo URL::base() . 'TodayTipManager/deleteTip/' . $tip->id; ?>"><?php echo __('Delete'); ?></a> <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
                            </p>
                        </div>
                    </div>
                </td>
