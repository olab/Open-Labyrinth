...
<div>
    ...
    <div class="container-fluid">
        ...
        <div class="controls">
            <a  href="<?php echo URL::base() . 'labyrinthManager/caseWizard/5/createSkin/' . $templateData['map']; ?>"
               style="float:right;" class="btn btn-primary">Step 5 - Edit Skin</a>
            <a class="btn btn-primary" href="<?php echo URL::base(); ?>" style="float:right;" class="wizard_button">Save & return later</a>
            <a class="btn btn-primary" href="<?php echo URL::base() . 'labyrinthManager/caseWizard/3/' . $templateData['map']; ?>"
               style="float:left;" class="wizard_button">Return to step 3.</a>
        </div>
    </div>
</div>
