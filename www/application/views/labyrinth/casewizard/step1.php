...
<form id="step2_form" method="post" class="form-horizontal"
      action="<?php echo URL::base() . 'labyrinthManager/caseWizard/2/addNewLabyrinth' . (isset($templateData['map']) ? '/' . $templateData['map']->id : ''); ?>">
    ...
    <fieldset class="fieldset">
        ...
        navigate it in a certain time.">
            ...
            <div class="controls">
                ...
                <label class="radio">
                    <?php echo __('Off'); ?>
                    <input <?php if(isset($templateData['map']) && !$templateData['map']->timing) echo 'checked'; ?> id="timing-off" type="radio" name="timing"
                           value=0>
                </label>
            </div>
        </div>
