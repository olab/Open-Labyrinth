    ...
    <tr>
        <td valign="top" bgcolor="#bbbbcb">
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="4" bgcolor="#ffffff">
                ...
                <tr align="left">
                    <td nowrap=""> <p><a href="uploadMVP.asp"><?php echo __('import MedBiquitous Virtual Patient'); ?><img src="<?php echo URL::base(); ?>images/medbiq_logo_wee.gif" alt="MedBiq" width="53" height="24" align="absmiddle" id="Img2" border="0">
                            </a></p></td>
                </tr>
                <tr align="left">
