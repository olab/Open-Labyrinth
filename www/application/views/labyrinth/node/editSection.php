            ...
            <td valign="top" bgcolor="#bbbbcb">
                ...
                <table width="100%" cellpadding="6">
                    <tr bgcolor="#ffffff"><td>
                            ...
                            <p>section title: <input type="text" name="sectiontitle" size="20" value="<?php echo $templateData['section']->name; ?>"> 
                                [<a href="<?php echo URL::base().'nodeManager/deleteNodeSection/'.$templateData['map']->id.'/'.$templateData['section']->id; ?>">delete</a>]
                            </p>
                            ...
                            <?php if(count($templateData['section']->nodes) > 0) { ?>
                                <?php foreach($templateData['section']->nodes as $node) { ?>
                                    <p>
                                        ...
                                        - node conditional: <?php echo $node->order; ?> - ordered
                                        <select name="node_<?php echo $node->id; ?>">
                                            ...
                                            <?php } ?>
                                        </select> [<a href="<?php echo URL::base().'nodeManager/deleteNodeBySection/'.$templateData['map']->id.'/'.$templateData['section']->id.'/'.$node->node->id; ?>">delete</a>]
                                    </p>
                                <?php } ?>
                            <?php } ?>
                            ...
                            <form action="<?php echo URL::base().'nodeManager/addNodeInSection/'.$templateData['map']->id.'/'.$templateData['section']->id; ?>" method="post">
                                <p>add an unallocated node to this section: 
                                    <select name="mnodeID">
                                ...
                                <input type="submit" name="Submit" value="submit"><br><table border="0" width="100%" cellpadding="1">
                            </form>
                            </table>
                        </td></tr>
                </table>
