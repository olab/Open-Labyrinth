                    ...
                    <tr bgcolor="#ffffff"><td>
                            ...
                            <form action="<?php echo URL::base().'nodeManager/saveConditional/'.$templateData['node']->id.'/'.$templateData['countOfCondidtionFiled']; ?>" method="post">
                                <table width="100%" cellpadding="6" border="0">
                                    <tr><td align="right" width="30%"><p>first add enough nodes</p></td><td><p></p><p>currently=<?php echo $templateData['countOfCondidtionFiled']; ?>, [<a href="<?php echo URL::base().'nodeManager/addConditionalCount/'.$templateData['node']->id.'/'.$templateData['countOfCondidtionFiled']; ?>">add</a>] <?php if($templateData['countOfCondidtionFiled'] > 0) { ?>[<a href="<?php echo URL::base().'nodeManager/deleteConditionalCount/'.$templateData['node']->id.'/'.$templateData['countOfCondidtionFiled']; ?>">delete</a>]<?php } ?></p><p></p></td></tr>
                                    ...
                                    <tr><td align="right" width="30%"><p>and then ...</p></td><td><p><input type="submit" name="Submit" value="submit"></p></td></tr>
                                </table>
                            </form></td></tr>
                </table>
            </td>
