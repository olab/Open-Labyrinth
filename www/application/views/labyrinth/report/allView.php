            ...
            <td valign="top" bgcolor="#bbbbcb">
                ...
                <table width="100%" cellpadding="6">
                    <tr bgcolor="#ffffff"><td>
                            ...
                            <p>click to view performance by session</p>
                            ...
                            <p><a href="<?php echo URL::base(); ?>reportManager/showReport/<?php echo $session->id; ?>">
                                <?php echo date('Y.m.d H:i:s', $session->start_time); ?></a> user: <?php echo $session->user->nickname; ?> (<?php echo count($session->traces); ?> clicks) (0 bookmarks)</p>
                            <?php } ?>
                            <?php } ?>
                        </td></tr>
                </table>
