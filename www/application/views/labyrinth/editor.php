                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    <td width="25%" align="left" nowrap="">
                                        ...
                                        <p><a href="<?php echo URL::base().'visualManager/index/'.$templateData['map']->id; ?>" target="_blank"><img src="<?php echo URL::base(); ?>images/OL_visualeditor_wee.gif" alt="visual editor" align="absmiddle" border="0">&nbsp;&nbsp;<strong><?php echo __('visual editor'); ?></strong></a></p><a href="mapview.asp?mapid=6" target="_blank">
                                        </a><p><a href="<?php echo URL::base().'feedbackManager/index/'.$templateData['map']->id; ?>" target="_blank"></a><a href="<?php echo URL::base().'feedbackManager/index/'.$templateData['map']->id; ?>"><img src="<?php echo URL::base(); ?>images/OL_feedback_wee.gif" alt="feedback" align="absmiddle" border="0">&nbsp;&nbsp;<strong><?php echo __('feedback'); ?></strong></a></p>
