...
if (isset($templateData['map'])) {
    ...
    <div class="page-header"><h1><?php if (!isset($templateData['question'])) {
    ...
    <fieldset class="fieldset">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <input type="radio" name="qshow"
                           value="1" <?php if (isset($templateData['question']) and $templateData['question']->show_answer == 1) echo 'checked=""'; ?>>
                    show
                </label>
                <label class="radio">
                    <input type="radio" name="qshow"
                           value="0" <?php if (isset($templateData['question']) and $templateData['question']->show_answer == 0) echo 'checked=""'; ?>>
                    do not show
                </label>
            </div>
        </div>
                ...
                <select id="scount" name="scount">
                    ...
                    <?php if (isset($templateData['counters']) and count($templateData['counters']) > 0) { ?>
                        <?php foreach ($templateData['counters'] as $counter) { ?>
                            <option
                                value="<?php echo $counter->id; ?>" <?php if (isset($templateData['question']) and $counter->id == $templateData['question']->counter_id) echo 'selected=""'; ?>><?php echo $counter->name; ?></option>
                        <?php } ?>
                    <?php } ?>
                </select>
            </div>
        ...
        <?php for ($i = 1; $i <= (int)$templateData['args']; $i++) { ?>
            <fieldset class="fieldset">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            <input type="radio" name="qresp<?php echo $i ?>y"
                                   value="1" <?php if (isset($templateData['question']) and count($templateData['question']->responses) > 0 and $templateData['question']->responses[$i - 1]->is_correct == 1) echo 'checked=""'; ?>>
                            correct
                        </label>
                        <label class="radio">
                            <input type="radio" name="qresp<?php echo $i ?>y"
                                   value="0" <?php if (isset($templateData['question']) and count($templateData['question']->responses) > 0 and $templateData['question']->responses[$i - 1]->is_correct == 0) echo 'checked=""'; ?>>
                            incorrect
                        </label>
                    </div>
                </div>
                        ...
                        <select id="" name="qresp<?php echo $i; ?>s">
                            <?php for ($j = -10; $j <= 10; $j++) { ?>
                                <option value="<?php echo $j; ?>"
                                    <?php if (isset($templateData['question']) and count($templateData['question']->responses) > 0 and $templateData['question']->responses[$i - 1]->score == $j) {
                                    echo 'selected=""';
                                } ?>
...
<div class="form-actions">
    ...
    <input class="btn btn-primary btn-large" type="submit" name="Submit" value="Save"></div>
</div>
    </form>
