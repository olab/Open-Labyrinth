    ...
    <fieldset class="fieldset">
        ...
        <table class="table table-striped table-bordered">
            ...
            foreach ($templateData['collection']->maps as $mp) { ?>
                <tr>
                    <td>
                        <a href="<?php echo URL::base().'renderLabyrinth/index/'.$mp->map->id; ?>"><?php echo $mp->map->name; ?></a>
                    </td>
                    <td><?php
                    if (in_array($mp->map->id, $templateData['canEdit'])) { ?>
                        <a href="<?php echo URL::base().'renderLabyrinth/index/'.$mp->map->id; ?>" class="btn btn-success btn-small"><i class="icon-play"></i>Play</a><?php
                    } ?>
                    </td>
                </tr><?php
            } ?>
