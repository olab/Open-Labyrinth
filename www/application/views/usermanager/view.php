        ...
        <td valign="top" bgcolor="#bbbbcb">
            ...
            <table width="100%" cellpadding="6">
                <tr bgcolor="#ffffff"><td>
                        <p><strong>users</strong>:&nbsp;<?php if (isset($templateData['userCount'])) echo $templateData['userCount']; ?>&nbsp;registered users&nbsp;[<a href=<?php echo URL::base() . 'usermanager/add' ?>>add user</a>]</p>
                        <table width="100%" cellpadding="2">
                            ...
                            if (isset($templateData['users'])) {
                                ...
                                foreach ($templateData['users'] as $user) {
                                    ...
                                    $outTD[$currentIndex] .= '<a href=' . URL::base() . 'usermanager/edit/' . $user->id . '>[' . __('edit') . ']</a>';
