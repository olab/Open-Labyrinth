            ...
            <table width="100%" cellpadding="6">
                <tr bgcolor="#ffffff"><td>
                        <form action=<?php echo URL::base().'usermanager/saveOldUser/'.$templateData['user']->id; ?> method="post">
                            <table>
                                <tr><td align="left"><p>username</p></td><td align="left"><p><?php echo $templateData['user']->username; ?>&nbsp;<a href=<?php echo URL::base().'usermanager/delete/'.$templateData['user']->id; ?>>[delete]</a></p></td></tr>
