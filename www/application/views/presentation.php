                        ...
                        <table border="0" width="100%" cellpadding="1">
                            <tr><td valign="top">
                                    ...
                                    <table cellpadding="2">
                                        ...
                                        <tr><td><p>skin</p></td><td><p><select name="skin"><option value="" selected="">select ...</option><option value="">Basic</option><option value="">Basic Exam</option><option value="">NOSM</option><option value="">PINE</option></select></p></td></tr>
