...
class Controller_Mesh extends Controller_Base
{
    public function action_index()
    {
        $view = View::factory('mesh/report');
    ...
    public function before()
    {
        if($this->request->action()!="api"){
            parent::before();
            Breadcrumbs::add(Breadcrumb::factory()->set_title(__('MESH Classifications'))->set_url(URL::base() . 'vocabulary/manager'));
