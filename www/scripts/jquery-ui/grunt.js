...
grunt.registerMultiTask( "copy", "Copy files to destination folder and replace 1.8.20 with pkg.version", function() {
	function replaceVersion( source ) {
		return source.replace( /1.8.20/g, grunt.config( "pkg.version" ) );
	}
