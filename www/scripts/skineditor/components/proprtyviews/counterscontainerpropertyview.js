...
var CountersContainerPropertyView = (function(parent) {
    inherit(parent, CountersContainerPropertyView);

    function CountersContainerPropertyView(viewModel) { 
        CountersContainerPropertyView.super.constructor.apply(this);
    ...
    CountersContainerPropertyView.prototype.AppendTo = function($container) {
    ...
    return CountersContainerPropertyView;
})(BlockPropertyView);