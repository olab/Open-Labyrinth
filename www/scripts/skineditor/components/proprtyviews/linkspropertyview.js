...
var LinksPropertyView = (function(parent) {
    inherit(parent, LinksPropertyView);

    function LinksPropertyView(viewModel) {
        LinksPropertyView.super.constructor.apply(this);
