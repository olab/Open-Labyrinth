...
var NodeTitlePropertyView = (function(parent) {
    inherit(parent, NodeTitlePropertyView);

    function NodeTitlePropertyView(viewModel) { 
        NodeTitlePropertyView.super.constructor.apply(this);
    ...
    NodeTitlePropertyView.prototype.AppendTo = function($container) {
