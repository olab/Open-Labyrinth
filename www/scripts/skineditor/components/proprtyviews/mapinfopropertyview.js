...
var MapInfoPropertyView = (function(parent) {
    inherit(parent, MapInfoPropertyView);

    function MapInfoPropertyView(viewModel) {
        MapInfoPropertyView.super.constructor.apply(this);
