var NodeContentPropertyModel = (function(parent) {
    inherit(parent, NodeContentPropertyModel);

    function NodeContentPropertyModel() {
        this.Name               = 'Node content component';
    ...
    NodeContentPropertyModel.prototype.GetObjectData = function(serializationInfo) {
    ...
    NodeContentPropertyModel.prototype.SetObjectData = function(serializationInfo) {
        if(serializationInfo == null || !(serializationInfo instanceof SerializationInfo)) {
    ...
    return NodeContentPropertyModel;
})(Serializable);