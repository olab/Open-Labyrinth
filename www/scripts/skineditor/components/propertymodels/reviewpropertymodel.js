var ReviewPropertyModel = (function(parent) {
    inherit(parent, ReviewPropertyModel);

    function ReviewPropertyModel() {
        ReviewPropertyModel.super.constructor.apply(this);

        this.Name               = 'Review component';
    ...
    ReviewPropertyModel.prototype.GetObjectData = function(serializationInfo) {
        if(serializationInfo == null || !(serializationInfo instanceof SerializationInfo)) {
            throw new Error('ReviewPropertyModel.GetObjectData: Serialization Info must be instance of object "SerializationInfo" and not be null');
        }
    ...
    ReviewPropertyModel.prototype.SetObjectData = function(serializationInfo) {
        if(serializationInfo == null || !(serializationInfo instanceof SerializationInfo)) {
