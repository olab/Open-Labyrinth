var Preview = function()
{
    ...
    self.Init = function(params)
    {
        ...
        if('visualEditor' in params) self.visualEditor = params.visualEditor;
    ...
    self.Render = function(nodes, links, viewport, width, height)
    {
        ...
        if (minCoords != null && maxCoords != null) offset = [-(minCoords[0] + (maxCoords[0] - minCoords[0]) * 0.5), -minCoords[1]];
    ...
    var GetMinCoords = function(nodes)
    {
        ...
        for (var i = 0; i < nodes.length; i++)
        {
            ...
            if(coords[0] > p[0]) coords[0] = p[0];
            if(coords[1] > p[1]) coords[1] = p[1];
        }
        return coords;
    };
